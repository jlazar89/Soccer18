...
import com.bluetag.wc.fragments.MatchDetailsFragment;
import com.bluetag.wc.model.GoalsListItems;
import com.bluetag.wc.model.MatchesListItems;
import com.bluetag.wc.utils.AnimationUtil;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
        ...
        switch (tag) {
            ...
            default:
                ...
                try {
                    ...
                    holder.tvDateTime.setText(toGmt(international));
                    // } else {
                    //     holder.tvDateTime.setText(toGmt(bangladeshi));
                    // }
                ...
                if(listItem.getStatus().equals("Live")){
                    holder.tvStatus.setText(listItem.getStatus());
                    holder.tvStatus.setTextColor(Color.GREEN);

                    holder.cardView.setCardBackgroundColor(Color.WHITE);

                }else if(listItem.getStatus().equals("Pending")){
                    holder.tvStatus.setText(listItem.getStatus());
                    holder.tvStatus.setTextColor(Color.GRAY);
                }else if(listItem.getStatus().equals("Next")){
                    holder.tvStatus.setText(listItem.getStatus());
                    holder.tvStatus.setTextColor(Color.BLUE);
                }else if(listItem.getStatus().equals("Finish")){
                    holder.tvStatus.setText(listItem.getStatus());
                    holder.tvStatus.setTextColor(Color.RED);

                    holder.cardView.setCardBackgroundColor(Color.parseColor("#e4bfef"));
                }
    ...
    public String toGmt(String serverDate) {
        // String serverDate = "22.06.2018 16:00";
        String DATE_FORMAT = "E dd.MM.yyyy HH:mm";
        String strDate;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        // Matches View
        TextView tvDateTime, tvRound, tvTeam1, tvTeam2, tvScore, tvStatus;
        ...
        public void onClick(View v) {
            switch (tag) {
                case "Matches":
                    ...
                    bundle.putString("DETAILS", itemsList.get(getAdapterPosition()).getDetails());
                    ...
                    if (fragmentManager.findFragmentByTag("MatchDetails") != null) {
                        ...
                        fragmentManager.beginTransaction().remove(fragmentManager.findFragmentByTag(MatchDetailsFragment.class.getSimpleName())).commit();
                        fragmentManager
                                .beginTransaction()
                                .replace(R.id.content_frame, fragment, MatchDetailsFragment.class.getSimpleName())
                                .addToBackStack(MatchDetailsFragment.class.getSimpleName())
                                .commit();
                    } else {
